...
# 使用账号专属 device_id，若缺失则临时生成
_raw_did = account.get("device_id", "").strip()
device_id = _raw_did if _raw_did and _raw_did != "deepseek_to_api" else base64.b64encode(os.urandom(64)).decode("ascii")
...
login_resp = requests.post(
    ...
    json={"email": email, "password": password, "device_id": device_id, "os": "android"},
    timeout=30,
